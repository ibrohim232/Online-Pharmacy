...
public class UserResponseDto extends BaseDto {
    ...
    public UserResponseDto(UUID id, LocalDateTime created, LocalDateTime updated, String fullName, String userName, String phoneNumber, UserRole userRoles, List<Permissions> permissions) {
